...
![sf package gif](https://www.example.com/images/sf_package.gif)
...
![sf package usage](https://www.example.com/images/sf_horst.jpg)

## Geometry Types in `sf`

::: columns
::: {.column width="50%"}
![WKT Primitives](https://www.example.com/images/wkt_primitives.png)
![WKT Multipart](https://www.example.com/images/wkt_multipart.png)
:::

::: {.column width="50%"}
![sf Classes](https://www.example.com/images/sf-classes.png)
:::
:::
...
![sf Concept Map](https://www.example.com/images/sf_concept_map.png)

## Dependencies of the `sf` Package

![sf Dependencies](https://www.example.com/images/sf_deps.png)
...
::: columns
::: {.column width="60%"}
![sf Cheatsheet 1](https://www.example.com/images/sf_cheatsheet.png)
:::

::: {.column width="40%"}
![sf Cheatsheet 2](https://www.example.com/images/sf_cheatsheet2.png)
:::
:::
